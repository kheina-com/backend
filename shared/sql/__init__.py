...
class FieldAttributes :
	...
	ex: orm:map[subtype.field:column,field:column2]
...
class SqlInterface :
	...
	async def where[T: BaseModel](self: Self, model: type[T], *where: Where, order: list[tuple[Field, Order]] = [], limit: Optional[int] = None, query: Optional[AwaitableQuery] = None) -> list[T] :
		table = self._table_name(model)
